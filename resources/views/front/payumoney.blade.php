...
$MERCHANT_KEY = "5589283"; // add your id
$SALT = "QzqmBackvB"; // add your id
...
<form action="<?php echo $action; ?>" method="post" name="payuForm"><br />
    ...
    <input type="hidden" name="amount" value="19" /><br />
    <input type="hidden" name="firstname" id="firstname" value="adil" /><br />
    <input type="hidden" name="email" id="email" value="adil@gmail.com" /><br />
