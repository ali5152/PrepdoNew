                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ url('EditChapterSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                               ...
                               <div class="alert alert-success">
                                  ...
                                  ?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Chapter Name
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="chapter_name" value="{{ $data->chapter_name }}" required="true" placeholder="Enter chapter name" class="form-control input-height" /> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Chapter Code

                                                    <span class="required"> * </span>

                                                </label>

                                                <input type="hidden" value="{{ $data->id }}" name="chapter_id">

                                                <div class="col-md-5">

                                                    <input type="text"  readonly="" name="chapter_code" required="true" value="{{ $data->chapter_code }}" placeholder="Enter chapter code" class="form-control input-height" /> </div>

                                            </div>

                                             <div class="form-group row">

                                                <label class="control-label col-md-3">Chapter Description
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <textarea name="chapter_des" class="form-control">{{ $data->chapter_detail }}</textarea>
                                         ...
                                         <!--    <div class="form-group row">
                                           ...
                                           <!--  <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Chapter Files ( Optional )
                                             ...
                                             <div class="form-group row">
                                              ...
                                              $files = DB::table('system_files')->where('chapter_id',$data->id)->get();
