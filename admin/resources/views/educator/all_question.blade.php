@include('educator/header')
					                                     ...
					                                     <div class="row">
					                                        ...
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="{{url('AddQuestion')}}" id="addRow" class="btn btn-info">
          ...
          <tbody>
			  ...
			  <td><a href="{{ url('EditQuestion') }}/{{ $value->id }}" class="btn btn-primary btn-xs">

				<i class="fa fa-pencil"></i>

				</a>

				<a href="{{ url('DeleteQuestion') }}/{{ $value->id }}"><button class="btn btn-default btn-xs">

				<i class="fa fa-trash-o "></i>

				</button></a> @if($value->status == 1)
                
                 <a href="{{ url('DisableQuestion') }}/{{ $value->id }}"><button class="btn btn-danger btn-xs">
               ...
               @else
                 ...
                 <a href="{{ url('EnableQuestion') }}/{{ $value->id }}"><button class="btn btn-success btn-xs">
