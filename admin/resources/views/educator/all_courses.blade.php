                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Exams List</div>
					                                    ...
					                                    <div class="row">
					                                        ...
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="{{url('AddExams')}}" id="addRow" class="btn btn-info">
        ...
        <thead>
          ...
          <tbody>
              ...
              <td>@if($value->status == 1) <font color="green"> Active </font> @elseif($value->status == 3) <font color="red"> Blocked </font> @else  <font color="red"> Non Active </font> @endif</td>
				...
				<td><a href="{{ url('EditExam') }}/{{ $value->id }}" class="btn btn-primary btn-xs">

				<i class="fa fa-pencil"></i>

				</a>

				<a href="{{ url('DeleteExam') }}/{{ $value->id }}"><button class="btn btn-default btn-xs">
				...
				<i class="fa fa-trash-o "></i>
                 ...
                 <a href="{{ url('DisableExam') }}/{{ $value->id }}"><button class="btn btn-danger btn-xs">
               ...
               @else
                 ...
                 <a href="{{ url('EnableExam') }}/{{ $value->id }}"><button class="btn btn-success btn-xs">
