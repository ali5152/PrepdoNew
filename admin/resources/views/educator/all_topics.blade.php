                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Exercise List</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Exercise List</li>
					                                    ...
					                                    <div class="row">
					                                        ...
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="{{url('AddExercise')}}" id="addRow" class="btn btn-info">
          ...
          <tbody>
          	...
          	@foreach($data as $value)
          	   ...
          	   <?php
                  ...
                  $type = DB::table('excercise_types')->where('id',$value->excercise_type)->first();
			  ...
			  <td><a href="{{ url('EditExcercise') }}/{{ $value->id }}" class="btn btn-primary btn-xs">

				<i class="fa fa-pencil"></i>

				</a>

				<a href="{{ url('DeleteExcercise') }}/{{ $value->id }}"><button class="btn btn-default btn-xs">
			...
			@if($value->status == 1)
                 ...
                 <a href="{{ url('DisableExcercise') }}/{{ $value->id }}"><button class="btn btn-danger btn-xs">
               ...
               @else
                 ...
                 <a href="{{ url('EnableExcercise') }}/{{ $value->id }}"><button class="btn btn-success btn-xs">
