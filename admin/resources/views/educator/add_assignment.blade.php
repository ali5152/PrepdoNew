                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Add Assignment</div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ url('AddAssignmentSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                                  ...
                                  ?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="assignment_name" value="{{ old('assignment_name') }}" required="true" placeholder="Enter assignment name" class="form-control input-height" /> </div>
                                            ...
                                            <!-- <div class="form-group row">
                                                ...
                                                <div class="col-md-5"> -->
                                                    ...
                                                    <input type="hidden" name="assignment_code" required="true" value="N/A" placeholder="Enter assignment code" class="form-control input-height" /> <!-- </div>
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <textarea name="assignment_des" class="form-control">{{ old('assignment_des') }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Select a Course
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Select a Topic
                                         ...
                                         <!--    <div class="form-group row">
                                           ...
                                           <!--  <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Assignment Files
