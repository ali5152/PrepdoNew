                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                     ...
                                     <form action="{{ url('EditStudentSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="roll_no" data-required="1" placeholder="Enter Roll No" value="{{ $data->roll_no }}" required = "true" class="form-control input-height" /> </div>
                                           ...
                                           <!--  <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input name="number" value="{{ $data->mobile_phone }}" required = "true" type="number" placeholder="mobile_number" class="form-control input-height" /> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Profile Picture ( Optional )
