                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Section List</div>
					                                    ...
					                                    <!-- <div class="row">
					                                        ...
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="{{url('AddSection')}}" id="addRow" class="btn btn-info">
          ...
          <tbody>
          	...
          	@foreach($data as $value)
          	   ...
          	   <?php
                  ...
                  //$course = DB::table('courses')->where('id',$value->course_id)->first();

                //  $chapter = DB::table('chapters')->where('id',$value->chapter_id)->first();

                  $topic = DB::table('topics')->where('id',$value->topic_id)->first();
               ...
               <td>@if($value->status == 1) <font color="green"> Active </font> @else <font color="red"> Non Active </font> @endif</td>

               <td> <?php 

                    $files = DB::table('system_files')->where('quiz_id',$value->id)->get();
			  ...
			  <td><a href="{{ url('EditSection') }}/{{ $value->id }}" class="btn btn-primary btn-xs">

				<i class="fa fa-pencil"></i>

				</a>

				<a href="{{ url('DeleteSection') }}/{{ $value->id }}"><button class="btn btn-default btn-xs">
			...
			@if($value->status == 1)
                 ...
                 <a href="{{ url('DisableSection') }}/{{ $value->id }}"><button class="btn btn-danger btn-xs">
               ...
               @else
                 ...
                 <a href="{{ url('EnableSection') }}/{{ $value->id }}"><button class="btn btn-success btn-xs">
