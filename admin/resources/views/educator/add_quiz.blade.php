                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ url('AddQuizSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                                  ...
                                  ?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="quiz_name" value="{{ old('quiz_name') }}" required="true" placeholder="Section Heading" class="form-control input-height" /> </div>
                                            ...
                                            <!-- <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Quiz Code
                                                ...
                                                <div class="col-md-5"> -->
                                                    ...
                                                    <input type="hidden" name="quiz_code" required="true" value="N/A" placeholder="" class="form-control input-height" /> <!-- </div>
                                           ...
                                           <!--   <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <textarea name="quiz_des" class="form-control" required="true">{{ old('quiz_des') }}</textarea>
                                          ...
                                          <!--   <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Select a Excercise
                                           ...
                                           <!--  <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Select a Chapter
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="form-control" required="true" name="chapter_id">

                                                        <option value="">Select an Option</option>

                                                        @foreach($data1 as $value1)

                                                         <option value="{{ $value1->id }}">{{ $value1->chapter_name }}</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="form-control" required="true" name="topic_id">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" name="instruction"  id="instruction" required="true" placeholder="Instruction 1" class="form-control input-height" /> </div>

                                                    <div class="col-md-2">

                                                    <input type="text" name="description" id="description" required="true" placeholder="Brief Description" class="form-control input-height" /> </div>
    ...
    <button type="button" class="delete-row">Delete Row</button>
                                         ...
                                         <!--    <div class="form-group row">
                                           ...
                                           <!--  <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Quiz Files

                                                </label>

                                                <div class="compose-editor">

                                                  <input type="file" class="default" required="true" name="files[]" multiple="">
