                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Assignment List</div>
					                                    ...
					                                    <div class="row">
					                                        ...
					                                        <div class="col-md-6 col-sm-6 col-6">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="{{url('AddProfessor')}}" id="addRow" class="btn btn-info">
          ...
          <tbody>
          	...
          	@foreach($data as $value)
               ...
               <td> <?php 
                    ...
                    $files = DB::table('system_files')->where('assignment_id',$value->id)->get();
			  ...
			  <td><a href="{{ url('EditAssignment') }}/{{ $value->id }}" class="btn btn-primary btn-xs">

				<i class="fa fa-pencil"></i>

				</a>

				<a href="{{ url('DeleteAssignment') }}/{{ $value->id }}"><button class="btn btn-danger btn-xs">
