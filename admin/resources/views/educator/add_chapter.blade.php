                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Add Chapter</div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ url('AddChapterSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                                  ...
                                  ?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="chapter_name" value="{{ old('chapter_name') }}" required="true" placeholder="Enter chapter name" class="form-control input-height" /> </div>
                                            ...
                                            <!-- <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
 -->
                                                    <input type="hidden" name="chapter_code" required="true" value="N/A" placeholder="Enter chapter code" class="form-control input-height" /><!--  </div>
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <textarea name="chapter_des" class="form-control">{{ old('chapter_des') }}</textarea>
                                         ...
                                         <!--    <div class="form-group row">
                                           ...
                                           <!--  <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Chapter Files
