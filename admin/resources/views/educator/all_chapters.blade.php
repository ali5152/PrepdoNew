                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Chaters List</div>
          ...
          <tbody>
          	...
          	@foreach($data as $value)
               ...
               <td> <?php 
                    ...
                    $files = DB::table('system_files')->where('chapter_id',$value->id)->get();
			  ...
			  <td><a href="{{ url('EditChapter') }}/{{ $value->id }}" class="btn btn-primary btn-xs">

				<i class="fa fa-pencil"></i>

				</a>

				<a href="{{ url('DeleteChapter') }}/{{ $value->id }}"><button class="btn btn-danger btn-xs">
