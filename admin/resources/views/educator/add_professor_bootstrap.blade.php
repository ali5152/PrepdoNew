                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Add Partners</div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ url('AddProfessorSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal"  enctype="multipart/form-data">
...
<!--                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
 -->
                                                    <input type="hidden" name="last_name" data-required="1" placeholder="Enter last name" value="" required = "true" class="form-control input-height" /> </div>
                                            ...
                                            <input type="hidden" id="dtp_input2" value="" />
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <input class="form-control input-height" name="exp_date" size="16" value="{{ old('exp_date') }}" required = "true" placeholder="Expiry Date" type="date" value="">
                                          ...
                                          <!--   <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="designation" data-required="1" placeholder="Count" value="{{ old('designation') }}" required = "true" class="form-control input-height" /> </div>
                                        ...
                                        <!--     <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input name="mobile_number" value="{{ old('mobile_number') }}" required = "true" type="number" placeholder="Mobile Number" class="form-control input-height" /> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                  ...
                                                  <select id="dates-field2" name="allowed_exams[]" class="multiselect-ui form-control" multiple="multiple">
                                                    @foreach($data as $value)
                                                       ...
                                                       <!--  <option value="215">{{ $value->course_name }}</option> -->
                                                    @endforeach
                                                </select>
                                              ...
                                              <!--  <div class="form-group row">
                                                ...
                                                <input class="form-control input-height" value="" required = "true" name="birth_date" size="16" placeholder="date of Birth" type="hidden" value="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Patner Logo

                                                </label>

                                                <div class="compose-editor">

                                                  <input type="file" name="profile_image" class="default" required="true">
