                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="{{ url('EditAssignmentSubmit') }}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                               ...
                               <div class="alert alert-success">
                                  ...
                                  ?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Assignment Name
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="assignment_name" value="{{ $data->name }}" required="true" placeholder="Enter assignment name" class="form-control input-height" /> </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Assignment Code
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="assignment_code" required="true" value="{{ $data->code }}" readonly="" placeholder="Enter assignment code" class="form-control input-height" /> </div>

                                            </div>

                                             <div class="form-group row">

                                                <label class="control-label col-md-3">Assignment Description
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <textarea name="assignment_des" class="form-control">{{ $data->detail }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Chapter
                                               ...
                                               $chapter = DB::table('chapters')->where('id',$data->chapter_id)->first();
                                                ...
                                                <div class="col-md-5">
                                                     ...
                                                     @if($chapter)
                                                      ...
                                                      <input type="text" class="form-control" readonly="" name="" value="{{ $chapter->chapter_name }}">
                                         ...
                                         <!--    <div class="form-group row">
                                           ...
                                           <!--  <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Assignment Files ( Optional )
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <label class="control-label col-md-3">Previous Files ( Click to Remove )
                                              ...
                                              $files = DB::table('system_files')->where('assignment_id',$data->id)->get();
                                             ...
                                             @foreach($files as $file)
                                              ...
                                              <a href="{{ url('DeleteFile') }}/{{ $file->id }}"> {{ $file->filename }} </a><br>
