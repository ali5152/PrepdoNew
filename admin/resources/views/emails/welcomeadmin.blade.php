                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent" style="background-color: black; color: white;">
                                            
                                            	<!-- // Begin Module: Standard Header Image \\ -->
                                            	<img src="http://quepertechnologies.com/DEMO/XTN/images/logo.png" alt="" height="80" width="200" />
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                you have been registered as a Admin at <strong>TezMart.pk</strong>.
                                                                <br />
                                                                <strong>Username : {{ $username }}</strong>
                                                                <strong>Password : {{ $password }}</strong>
                                                                <br />
                                                                <strong>Getting started:</strong> Login to Proceed.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content01">
                                                                        	<a href="{{ url('Admin/') }}" target="_blank"  style="text-decoration: none;"><font color ="white">Login as Admin</font></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
