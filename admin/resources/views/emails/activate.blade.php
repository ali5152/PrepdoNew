                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                We are glad to have you onboard with <strong>EAVE</strong>.
                                                                <br />
                                                                <br />
                                                                <strong><a href = "{{ url('PhoneVerification') }}">Click Here</a> to Complete your Registeration</strong>
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content01">
                                                                        	<a href="{{ url('login/') }}" style="text-decoration: none;"><font color ="white">Login</font></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
