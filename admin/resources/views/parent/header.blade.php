 ...
 <div class="page-header navbar navbar-fixed-top">
     <div class="page-header-inner ">
         ...
         <div class="page-logo">
             ...
             <span class="logo-default" style="font-size: 14px;"><img src="assets/img/dp.jpg" style="height:50px; border-radius:100px;" />  Amir Ali </span>
            </a>
         </div>
         <!-- logo end -->
   ...
   <li><a href="#" class="menu-toggler sidebar-toggler"><i class="icon-menu"></i></a></li>
     ...
     <!-- start manage user dropdown -->
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="padding:10px;">
        <a class="dropdown-item" href="{{url('ChangePass')}}">Change Pass</a>
